...
def main():
    ...
    #target_node = "SoftwareVulnerability:892728578927324:exploitWithEffort" # False
    #target_node = "Application:2213271547579497:reverseReach" #24
    ...
    shortest_path=find_path.a_star(atkgraph, start_node, target_node)
    print("\nShortest path:\n", shortest_path,"\n\n\n")

    # calculate the random path
    random_path=find_path.random_path(atkgraph, start_node, target_node)
    print("\nRandom path:\n", random_path,"\n\n\n")
